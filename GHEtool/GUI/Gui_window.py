...
class MainWindow(QtWidgets_QMainWindow, Ui_GHEtool):
    ...
    def __init__(self, Dialog: QtWidgets_QWidget, app: QtWidgets_QApplication) -> None:
        ...
        self.pushButton_General.setIcon(IC.Borehole)
    ...
    def eventFilter(self, object: QtWidgets_QPushButton, event) -> bool:
        """
    ...
    def funCheck(self, data1, data2) -> None:
    ...
    def checkDetermineDepth(self) -> None:
...
class CalcProblem(QtCore_QThread):
    ...
    def run(self) -> None:
        ...
        if Outside_Bounds:
            ...
            customField = gt_boreholes.rectangle_field(N_1=N_Max, N_2=N_Min, B_1=GD.B, B_2=GD.B, H=GD.H, D=4,
                                                       r_b=0.075)
            try:
...
class ImportGHEtool(QtCore_QThread):
    ...
    def run(self) -> None:
        ...
        GD = GroundData(100, 6, 1.5, 10, 0.05, 12, 10)
