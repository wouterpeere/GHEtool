...
It is shown that the speed difference is significant, but so is the difference in the result. With a constant Rb* value, it is important that the initial length is rather accurate.
"""
...
def sizing_with_Rb():
    ...
    data = GroundConstantTemperature(3, 10)  # ground data with an inaccurate guess of 100m for the borehole length
