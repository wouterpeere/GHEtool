...
def realistic_case():
    ...
    for rb in (90e-3,):
        ...
        plt.figure()
        plt.plot(flow_rates, list_rb_turbo_collector, label="TurboCollector (rb=110)")
        plt.plot(flow_rates, list_rb_muoviellipse, label="MuoviELLIPSE (rb=90)")
        ...
        plt.plot(flow_rates, list_dp_turbo_collector, label="TurboCollector (rb=110)")
        plt.plot(flow_rates, list_dp_muoviellipse, label="MuoviELLIPSE (rb=90)")
