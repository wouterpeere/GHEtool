...
def test_temp_profile_ground_data(qtbot):
    ...
    heat_cap = round_down(main_window.gui_structure.option_heat_capacity.get_value() * 1.5, 3)
    depth = round_down(main_window.gui_structure.option_depth.get_value() * 1.5, 3)
    ground_temp = round_down(main_window.gui_structure.option_ground_temp.get_value() * 1.5, 3)
    r_b = round_down(main_window.gui_structure.option_constant_rb.get_value() * 1.5, 3)
