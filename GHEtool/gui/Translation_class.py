...
class TrClass:
    __slots__ = 'Language', 'scenarioString', 'label_Language', 'pushButton_SaveScenario', 'pushButton_AddScenario', \
                ...
                'pushButton_borehole_resistance', 'label_Spanish', 'label_Galician', 'label_close', 'label_cancel', 'label_CancelText', \
    ...
    def changeLanguage(self, lang: int) -> None:
        ...
        if lang == 0:  # english
            ...
            self.label_fluid_mass_flow_rate: str = 'Mass flow rate per borehole [kg/s]: '
        ...
        if lang == 2:  # Dutch # thanks to Wouter
            ...
            self.label_fluid_mass_flow_rate: str = 'Massadebiet per boorgat[kg/s]: '
        ...
        if lang == 5:  # spanish thanks to Iago
            ...
            self.pushButton_start_multiple: str = 'Calcular todos los escenarios'
            self.pushButton_start_single: str = 'Calcular escenario actual'
            ...
            self.toolBoxDataLocation: str = 'Ubicación de datos en fileImport'
            ...
            self.checkBox_SizeBorefield: str = 'Dimensionar campo de captación por anchura y longitud'
            self.label_H_max: str = 'Profundidad máxima del pozo [m]: '
            self.label_B_min: str = 'Espaciado mínimo entre pozos [m]: '
            self.label_B_max: str = 'Espaciado máximo entre pozos [m]: '
            self.label_MaxWidthField: str = 'Anchura máxima del campo rectangular [m]: '
            self.label_MaxLengthField: str = 'Longitud máxima del campo rectangular [m]: '
            self.label_Size_B: str = 'Espaciado entre pozos: '
            self.label_Size_L: str = 'Longitud del campo rectangular: '
            self.label_Size_W: str = 'Anchura del campo rectangular: '
            self.label_German: str = 'Alemán'
            self.label_English: str = 'Inglés'
            self.label_Dutch: str = 'Neerlandés'
            self.label_Italian: str = 'Italiano'
            self.label_French: str = 'Francés'
            self.label_Spanish: str = 'Español'
            self.label_Galician: str = 'Gallego'
            self.label_New: str = 'Nuevo Proyecto'
            self.label_Save: str = 'Guardar Proyecto'
            self.label_Open: str = 'Abrir Proyecto'
            self.label_Save_As: str = 'Guardar como'
            self.Calculation_Finished: str = 'Cálculo finalizado'
            self.GHE_tool_imported: str = 'GHEtool importado'
            self.GHE_tool_imported_start: str = 'Empezar a importar GHEtool'
            self.label_new_scenario: str = 'Introducir nuevo nombre de escenario'
            self.new_name: str = 'Nuevo nombre para '
            self.label_okay: str = 'Ok '
            self.label_abort: str = 'Abortar '
            self.NoBackupFile: str = 'sin copia de seguridad fileImport'
            self.pushButton_borehole_resistance: str = 'Resistencia\ndel pozo'
            self.label_close: str = 'Cerrar'
            self.label_cancel: str = 'Cancelar'
            self.label_CancelText: str = 'Está seguro que desea salir? Los cambios sin guardar se perderán.'
            self.label_CancelTitle: str = 'Aviso'
            self.label_LeaveScenarioText: str = 'Está seguro que desea abandonar el escenario? Los cambios sin guardar se ' \
                                                'perderán.'
            self.label_LeaveScenario: str = 'Abandonar escenario'
            self.label_StayScenario: str = 'Permanencer por escenario'
            self.X_Axis_Load: str = 'Mes del año'
            self.Y_Axis_Load_P: str = 'Carga térmica pico restante [kW]'
            self.Y_Axis_Load_Q: str = 'Energía térmica restante [kWh]'
            self.label_aim: str = 'Objetivo de la simulación'
            self.button_rename_scenario: str = 'Renombrar escenario'
            self.label_aim_question: str = 'Cuál es el objetivo de la simulación?'
            self.comboBoxSizeMethodList: list = ['Rápida', 'Robusta']
            self.comboBox_AimList: list = ['Determinar el perfil de temperatura', 'Determinar la profundidad requerida',
                                           'Dimensionar el campo de captación por anchura y longitud',
                                           'Optimizar el perfil de carga']
            self.label_Seperator: str = 'Separador en el CSV-fileImport:'
            self.comboBox_SeperatorList: list = ["Punto y coma ';'", "Coma ','"]
            self.label_data_file: str = 'Seleccionar datos fileImport'
            self.label_Scenario_Head: str = 'Ajustes de guardar escenario'
            self.checkBox_AutoSaving: str = 'Guardado automático'
            self.label_Scenario_Hint: str = 'Si selecciona la opción de autoguardado el escenario será automáticamente guardado si un ' \
                                            'escenario es modificado. De lo contrario el escenario debe de ser guardado con el ' \
                                            'botón de \'Actualizar escenario\' en la esquina superior izquierda si no quiere' \
                                            ' perder los cambios realizados.'
            self.label_Borehole_Resistance: str = 'Resistencia del pozo equivalente'
            self.label_Rb_calculation_method: str = 'Método de cálculo:'
            self.comboBox_Rb_methodList: list = ['Valor constante conocido', 'Valor constante desconocido',
                                                 'Actualizar valor durante el cálculo']
            self.label_fluid_data: str = 'Datos del fluido'
            self.label_fluid_lambda: str = 'Conductividad térmica [W/mK]: '
            self.label_fluid_mass_flow_rate: str = 'Flujo másico [kg/s]: '
            self.label_fluid_density: str = 'Densidad [kg/m³]:'
            self.label_fluid_thermal_capacity: str = 'Capacidad térmica [J/kg K]:'
            self.label_fluid_viscosity: str = 'Viscosidad dinámica [Pa s]:'
            self.label_pipe_data: str = 'Datos de la sonda'
            self.label_NumberOfPipes: str = 'Número de tubos [#]:'
            self.label_grout_conductivity: str = 'Conductividad térmica del relleno [W/mK]: '
            self.label_pipe_conductivity: str = 'Conductividad térmica de la sonda [W/mK]: '
            self.label_pipe_outer_radius: str = 'Radio exterior de la sonda [m]: '
            self.label_pipe_inner_radius: str = 'Radio interior de la sonda [m]: '
            self.label_borehole_radius: str = 'Radio del pozo [m]:'
            self.label_pipe_distance: str = 'Distancia de la sonda al centro [m]:'
            self.label_pipe_roughness: str = 'Rugosidad de la sonda [m]:'
            self.label_borehole_burial_depth: str = 'Profundidad de entierro [m]:'
            self.label_ResOptimizeLoad1: str = 'La carga pico para calefacción/refrigeración es: '
            self.label_ResOptimizeLoad2: str = 'La carga para calefacción/refrigeración es: '
            self.label_ResOptimizeLoad3: str = 'Esto es '
            self.label_ResOptimizeLoad4: str = '% de la carga total. '
            self.label_ResOptimizeLoad5: str = 'La carga pico restante para calefacción/refrigeración es: '
            self.label_ResOptimizeLoad6: str = 'La carga restante para calefacción/refrigeración es: '
            self.NotCalculated: str = 'No calculado'
            self.NoSolution: str = 'No se ha encontrado una solución'
            self.label_decimal: str = 'Símbolo decimal en CSV-fileImport:'
            self.comboBox_decimalList: list = ["Punto '.'", "Coma ','"]
            self.createLists()
        if lang == 6:  # galician thanks to Iago
            ...
            self.scenarioString: str = 'Escenario'
            self.pushButton_start_multiple: str = 'Calcular todos os escenarios'
            self.pushButton_start_single: str = 'Calcular o escenario actual'
            self.pushButton_Cancel: str = 'Saír'
            self.pushButton_General: str = 'Pozo \ne chan'
            self.pushButton_thermalDemands: str = 'Cargas \ntérmicas'
            self.pushButton_Results: str = 'Resultados'
            self.label_Status: str = 'Progreso: '
            self.label_File: str = 'Arquivo'
            self.label_Calculation: str = 'Cálculo'
            self.label_Settings: str = 'Settings'
            ...
            self.checkBox_SizeBorefield: str = 'Dimensionar o campo de captación por anchura e lonxitude'
            self.label_H_max: str = 'Profundidade máxima do pozo [m]: '
            self.label_B_min: str = 'Espazamento mínimo entre pozos [m]: '
            self.label_B_max: str = 'Espazamento máximo entre pozos [m]: '
            self.label_MaxWidthField: str = 'Anchura máxima do campo rectangular [m]: '
            self.label_MaxLengthField: str = 'Lonxitude máxima do campo rectangular [m]: '
            self.label_Size_B: str = 'Espazamento entre pozos: '
            self.label_Size_L: str = 'Lonxitude do campo rectangular: '
            self.label_Size_W: str = 'Anchura do campo rectangular: '
            self.label_German: str = 'Alemán'
            self.label_English: str = 'Inglés'
            self.label_Dutch: str = 'Neerlandés'
            self.label_Italian: str = 'Italiano'
            self.label_French: str = 'Francés'
            self.label_Spanish: str = 'Español'
            self.label_Galician: str = 'Galego'
            self.label_New: str = 'Novo Proxecto'
            self.label_Save: str = 'Gardar Proxecto'
            self.label_Open: str = 'Abrir Proxecto'
            self.label_Save_As: str = 'Gardar como'
            self.Calculation_Finished: str = 'Cálculo rematado'
            self.GHE_tool_imported: str = 'GHEtool importado'
            self.GHE_tool_imported_start: str = 'Comezar a importar GHEtool'
            self.label_new_scenario: str = 'Introducir novo nome de escenario'
            self.new_name: str = 'Novo nome para '
            self.label_okay: str = 'Ok '
            self.label_abort: str = 'Abortar '
            self.NoBackupFile: str = 'sen copia de seguridade fileImport'
            self.pushButton_borehole_resistance: str = 'Resistencia\ndo pozo'
            self.label_close: str = 'Pechar'
            self.label_cancel: str = 'Cancelar'
            self.label_CancelText: str = 'Está seguro que desexa salir? Os trocos sen gardar perderanse.'
            self.label_CancelTitle: str = 'Aviso'
            self.label_LeaveScenarioText: str = 'Está seguro que desexa abandonar o escenario? Os trocos sen gardar ' \
                                                'perderanse.'
            self.label_LeaveScenario: str = 'Abandonar escenario'
            self.label_StayScenario: str = 'Permanencer por escenario'
            self.X_Axis_Load: str = 'Mes do ano'
            self.Y_Axis_Load_P: str = 'Carga térmica pico restante [kW]'
            self.Y_Axis_Load_Q: str = 'Enerxía térmica restante [kWh]'
            self.label_aim: str = 'Obxectivo da simulación'
            self.button_rename_scenario: str = 'Renomear escenario'
            self.label_aim_question: str = 'Cal é o obxectivo da simulación?'
            self.comboBoxSizeMethodList: list = ['Rápida', 'Robusta']
            self.comboBox_AimList: list = ['Determinar o perfil de temperaturas', 'Determinar a profundidade requerida',
                                           'Dimensionar o campo de captación por anchura e lonxitude',
                                           'Optimizar o perfil de carga']
            self.label_Seperator: str = 'Separador no CSV-fileImport:'
            self.comboBox_SeperatorList: list = ["Punto e coma ';'", "Coma ','"]
            self.label_data_file: str = 'Escoller datos fileImport'
            self.label_Scenario_Head: str = 'Ajustes de guardar escenario'
            self.checkBox_AutoSaving: str = 'Guardado automático'
            self.label_Scenario_Hint: str = 'Se escolle a opción de autogardado o escenario será automáticamente gardado se un ' \
                                            'escenario é modificado. En caso contrario o escenario debe ser gardado co ' \
                                            'botón de \'Actualizar escenario\' na esquina superior esquerda se non quere' \
                                            ' perder os trocos feitos.'
            self.label_Borehole_Resistance: str = 'Resistencia do pozo equivalente'
            self.label_Rb_calculation_method: str = 'Método de cálculo:'
            self.comboBox_Rb_methodList: list = ['Valor constante coñecido', 'Valor constante descoñecido',
                                                 'Actualizar valor durante o cálculo']
            self.label_fluid_data: str = 'Datos do fluído'
            self.label_fluid_lambda: str = 'Conductividade térmica [W/mK]: '
            self.label_fluid_mass_flow_rate: str = 'Fluxo másico [kg/s]: '
            self.label_fluid_density: str = 'Densidade [kg/m³]:'
            self.label_fluid_thermal_capacity: str = 'Capacidade térmica [J/kg K]:'
            self.label_fluid_viscosity: str = 'Viscosidade dinámica [Pa s]:'
            self.label_pipe_data: str = 'Datos da sondaxe'
            self.label_NumberOfPipes: str = 'Número de tubos [#]:'
            self.label_grout_conductivity: str = 'Conductividade térmica del recheo [W/mK]: '
            self.label_pipe_conductivity: str = 'Conductividade térmica da sondaxe [W/mK]: '
            self.label_pipe_outer_radius: str = 'Radio exterior da sondaxe [m]: '
            self.label_pipe_inner_radius: str = 'Radio interior da sondaxe [m]: '
            self.label_borehole_radius: str = 'Radio do pozo [m]:'
            self.label_pipe_distance: str = 'Distancia da sondaxe ao centro [m]:'
            self.label_pipe_roughness: str = 'Rugosidade da sondaxe [m]:'
            self.label_borehole_burial_depth: str = 'Profundidade de enterramento [m]:'
            self.label_ResOptimizeLoad1: str = 'A carga pico para calefacción/refrigeración é: '
            self.label_ResOptimizeLoad2: str = 'A carga para calefacción/refrigeración é: '
            self.label_ResOptimizeLoad3: str = 'Esto é '
            self.label_ResOptimizeLoad4: str = '% da carga total. '
            self.label_ResOptimizeLoad5: str = 'A carga pico restante para calefacción/refrigeración é: '
            self.label_ResOptimizeLoad6: str = 'A carga restante para calefacción/refrigeración é: '
            self.NotCalculated: str = 'Non calculado'
            self.NoSolution: str = 'Non se atopou unha solución'
            self.label_decimal: str = 'Símbolo decimal no CSV-fileImport:'
            self.comboBox_decimalList: list = ["Punto '.'", "Coma ','"]
            self.pushButton_start_multiple: str = 'Calcular todos os escenarios'
            self.pushButton_start_single: str = 'Calcular o escenario actual'
            self.toolBoxDataLocation: str = 'Localización dos datos en fileImport'
            self.createLists()