...
class IntValue(Option):
    def __init__(
        self, default_parent: qt_w.QWidget, widget_name: str, label: str, default_value: int, minimal_value: int = 0, maximal_value: int = 100, step: int = 1
    ):
        super().__init__(default_parent, widget_name, label, default_value)
...
class FileName(Option):
    def __init__(
        self, default_parent: qt_w.QWidget, widget_name: str, label: str, default_value: str, dialog_text: str, error_text: str, status_bar: qt_w.QStatusBar
    ):
        super().__init__(default_parent, widget_name, label, default_value)
