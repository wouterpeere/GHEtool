...
def test_4_sensitivity():
    ...
    baseload_cooling = np.array([0,0,8.085*744,21.107*720,35.048*744,43.666*720,46.983*744,44.389*744,34.678*720,18.686*744,2.983*720,0])
    peak_heating = np.array([64.946,60.735,43.518,37.849,0,0,0,0,0,5.737,42.315,57.209])
    peak_cooling = np.array([35.77,53.548,83.086,93.549,120.782,125.7581,125.7581,125.7581,111.780,97.338,52.843,34.284])
    ...
    baseload_cooling = np.array([0,0,8.085*744,21.107*720,35.048*744,43.666*720,46.983*744,44.389*744,34.678*720,18.686*744,2.983*720,0])
    peak_heating = np.array([64.946,60.735,43.518,37.849,0,0,0,0,0,5.737,42.315,57.209])
    peak_cooling = np.array([35.77,53.548,83.086,93.549,120.782,130.893,153.7044,131.761,111.780,97.338,52.843,34.284])
