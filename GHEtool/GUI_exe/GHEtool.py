...
class Borefield:
    __slots__ = 'baseloadHeating', 'baseloadCooling', 'H', 'H_init', 'B', 'N_1', 'N_2', 'Rb', 'k_s', 'Tg', 'ty', 'tm',\
                ...
                'resultsPeakCooling', 'resultsMonthCooling', 'resultsMonthHeating', 'Tb', 'H_max', 'maxSimulationPeriod'
    ...
    def __init__(self, simulationPeriod: int, numberOfBoreholes: int = None, peakHeating: list = None,
        ...
        self.maxSimulationPeriod = 100
        self.defaultTimeArray = timeValues(self.maxSimulationPeriod)  # sec
    ...
    def GetData(self):
        ...
        if MaxN == 1:
            from Data.data_1x1 import data
            return data
        if MaxN == 2:
            if MinN == 1:
                from Data.data_2x1 import data
                return data
            from Data.data_2x2 import data
            return data
        if MaxN == 3:
            if MinN == 1:
                from Data.data_3x1 import data
                return data
            if MinN == 2:
                from Data.data_3x2 import data
                return data
            from Data.data_3x3 import data
            return data
        if MaxN == 4:
            if MinN == 1:
                from Data.data_4x1 import data
                return data
            if MinN == 2:
                from Data.data_4x2 import data
                return data
            if MinN == 3:
                from Data.data_4x3 import data
                return data
            from Data.data_4x4 import data
            return data
        if MaxN == 5:
            if MinN == 1:
                from Data.data_5x1 import data
                return data
            if MinN == 2:
                from Data.data_5x2 import data
                return data
            if MinN == 3:
                from Data.data_5x3 import data
                return data
            if MinN == 4:
                from Data.data_5x4 import data
                return data
            from Data.data_5x5 import data
            return data
        if MaxN == 6:
            if MinN == 1:
                from Data.data_6x1 import data
                return data
            if MinN == 2:
                from Data.data_6x2 import data
                return data
            if MinN == 3:
                from Data.data_6x3 import data
                return data
            if MinN == 4:
                from Data.data_6x4 import data
                return data
            if MinN == 5:
                from Data.data_6x5 import data
                return data
            from Data.data_6x6 import data
            return data
        if MaxN == 7:
            if MinN == 1:
                from Data.data_7x1 import data
                return data
            if MinN == 2:
                from Data.data_7x2 import data
                return data
            if MinN == 3:
                from Data.data_7x3 import data
                return data
            if MinN == 4:
                from Data.data_7x4 import data
                return data
            if MinN == 5:
                from Data.data_7x5 import data
                return data
            if MinN == 6:
                from Data.data_7x6 import data
                return data
            from Data.data_7x7 import data
            return data
        if MaxN == 8:
            if MinN == 1:
                from Data.data_8x1 import data
                return data
            if MinN == 2:
                from Data.data_8x2 import data
                return data
            if MinN == 3:
                from Data.data_8x3 import data
                return data
            if MinN == 4:
                from Data.data_8x4 import data
                return data
            if MinN == 5:
                from Data.data_8x5 import data
                return data
            if MinN == 6:
                from Data.data_8x6 import data
                return data
            if MinN == 7:
                from Data.data_8x7 import data
                return data
            from Data.data_8x8 import data
            return data
        if MaxN == 9:
            if MinN == 1:
                from Data.data_9x1 import data
                return data
            if MinN == 2:
                from Data.data_9x2 import data
                return data
            if MinN == 3:
                from Data.data_9x3 import data
                return data
            if MinN == 4:
                from Data.data_9x4 import data
                return data
            if MinN == 5:
                from Data.data_9x5 import data
                return data
            if MinN == 6:
                from Data.data_9x6 import data
                return data
            if MinN == 7:
                from Data.data_9x7 import data
                return data
            if MinN == 8:
                from Data.data_9x8 import data
                return data
            from Data.data_9x9 import data
            return data
        if MaxN == 10:
            if MinN == 1:
                from Data.data_10x1 import data
                return data
            if MinN == 2:
                from Data.data_10x2 import data
                return data
            if MinN == 3:
                from Data.data_10x3 import data
                return data
            if MinN == 4:
                from Data.data_10x4 import data
                return data
            if MinN == 5:
                from Data.data_10x5 import data
                return data
            if MinN == 6:
                from Data.data_10x6 import data
                return data
            if MinN == 7:
                from Data.data_10x7 import data
                return data
            if MinN == 8:
                from Data.data_10x8 import data
                return data
            if MinN == 9:
                from Data.data_10x9 import data
                return data
            from Data.data_10x10 import data
            return data
        if MaxN == 11:
            if MinN == 1:
                from Data.data_11x1 import data
                return data
            if MinN == 2:
                from Data.data_11x2 import data
                return data
            if MinN == 3:
                from Data.data_11x3 import data
                return data
            if MinN == 4:
                from Data.data_11x4 import data
                return data
            if MinN == 5:
                from Data.data_11x5 import data
                return data
            if MinN == 6:
                from Data.data_11x6 import data
                return data
            if MinN == 7:
                from Data.data_11x7 import data
                return data
            if MinN == 8:
                from Data.data_11x8 import data
                return data
            if MinN == 9:
                from Data.data_11x9 import data
                return data
            if MinN == 10:
                from Data.data_11x10 import data
                return data
            from Data.data_11x11 import data
            return data
        if MaxN == 12:
            if MinN == 1:
                from Data.data_12x1 import data
                return data
            if MinN == 2:
                from Data.data_12x2 import data
                return data
            if MinN == 3:
                from Data.data_12x3 import data
                return data
            if MinN == 4:
                from Data.data_12x4 import data
                return data
            if MinN == 5:
                from Data.data_12x5 import data
                return data
            if MinN == 6:
                from Data.data_12x6 import data
                return data
            if MinN == 7:
                from Data.data_12x7 import data
                return data
            if MinN == 8:
                from Data.data_12x8 import data
                return data
            if MinN == 9:
                from Data.data_12x9 import data
                return data
            if MinN == 10:
                from Data.data_12x10 import data
                return data
            if MinN == 11:
                from Data.data_12x11 import data
                return data
            from Data.data_12x12 import data
            return data
    ...
    def gfunction(self, timeValue, H):
        ...
        # load data file
        data = data if data is not None else pk_load(open("Data/"+name, "rb"))
        ...
        try:
            if self.customGfunction is None:
                ...
                if not isinstance(timeValue, float):
                    ...
                    gvalue = interpolate_interpn(points, values,
                                                 np_array([[self.B, self.k_s, H, t] for t in timeValue]))
                else:
