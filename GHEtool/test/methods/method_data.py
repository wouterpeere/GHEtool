...
borefield.set_min_ground_temperature(0)
list_of_test_objects.add(SizingObject(borefield, error_L2=ValueError, error_L3=ValueError, name='Real case 1 (Error)'))
borefield.sizing_setup(max_nb_of_iterations=20)
...
list_of_test_objects.add(SizingObject(borefield, L2_output=71.65, L3_output=74.888, quadrant=4,
...
list_of_test_objects.add(SizingObject(borefield, error_L2=RuntimeError, error_L3=ValueError, quadrant=2, name='Cannot size'))
