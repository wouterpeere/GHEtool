...
list_of_test_objects.add(
    SizingObject(borefield, L2_output=74.69584, L3_output=75.07376, quadrant=4, name='Real case 1 (Correct)'))
borefield.calculation_setup(atol=False)
list_of_test_objects.add(
    SizingObject(borefield, L2_output=74.722213, L3_output=75.087206, quadrant=4,
...
list_of_test_objects.add(SizingObject(borefield, L2_output=71.8834, L3_output=72.25072366, quadrant=4,
...
borefield.flow_data = ConstantDeltaTFlowRate(extraction=4, injection=4)
list_of_test_objects.add(
    SizingObject(borefield, L3_output=96.99048538977277, L4_output=81.15952849537456, quadrant=1,
...
list_of_test_objects.add(SizingObject(borefield, L3_output=86.43352339058546, name='Issue 435'))
