...
def test_hourly_to_monthly(hourly_borefield):
    hourly_borefield.convert_hourly_to_monthly()
...
def test_size(borefield):
    assert np.isclose(borefield.size(100), 92.06688246062056)
