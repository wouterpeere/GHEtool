...
@mark.parametrize('simulation_period', np.arange(10, 101, 10))
def test_new_calc_method(simulation_period: int):
    ...
    borefield.set_simulation_period(simulation_period)
    ...
    print(f'simulation_period: {simulation_period}; old: {(process_time_ns() - dt2):_.0f} ns; new: {(dt2 - dt1):_.0f} ns')
